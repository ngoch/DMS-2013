namespace DMS.Domain.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DMS.Domain.Repositories.DMSDbContext>
    {
        ...
        {
            context.PsychoQuestions.AddOrUpdate(
              p => p.Body,
